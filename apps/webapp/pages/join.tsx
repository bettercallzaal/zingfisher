...
import { Alert, Box, Card, Chip, CircularProgress, Divider, Grid, Stack, TextField, Typography } from '@mui/material';
        ...
        <Card variant='outlined' sx={{ p: 4, textAlign: 'center', borderColor: zaoPrimary }}>
          ...
          <Box sx={{ p: 2.5, bgcolor: 'background.paper', borderRadius: 1, mb: 4, textAlign: 'left' }}>
            ...
            <Typography variant='body1'>
              <strong>Display Name:</strong> {createdProfile.displayName}
            </Typography>
            <Typography variant='body1'>
              <strong>Handle:</strong> @{createdProfile.handle}
            </Typography>
            <Typography variant='body1'>
              <strong>Wallet:</strong> {createdProfile.address}
            </Typography>
            <Typography variant='body1'>
              <strong>Voucher Standing:</strong> {createdProfile.voucher.status}
            </Typography>
            <Divider sx={{ my: 1.5 }} />
            <Typography variant='subtitle2' color='text.secondary'>
              Declared Goals & Vision (Protocol Item 30)
            </Typography>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} justifyContent='center'>
            ...
            <Button variant='outlined' color='secondary' onClick={() => router.push('/learn')}>
    ...
    <Container>
      ...
      {existingProfile && existingProfile.zid !== null && existingProfile.zid >= 0 && (
        <Alert severity='info' sx={{ mb: 3 }} icon={<VerifiedUserIcon />}>
          ...
          <Button size='small' variant='text' onClick={() => router.push(`/member/${existingProfile.zid}`)}>
            View Profile
          </Button>
        </Alert>
      )}
      ...
      <Card variant='outlined' sx={{ p: 3, mb: 4, bgcolor: 'background.paper' }}>
        ...
        <Stack spacing={1.5}>
          ...
          <Box sx={{ display: 'flex', gap: 1.5 }}>
            ...
            <Typography variant='body2'>
              <strong>Stated Goals & Vision:</strong> Declare what you are building and where you want to go so peers
              can align with your creative work.
            </Typography>
          </Box>
          <Box sx={{ display: 'flex', gap: 1.5 }}>
            <Chip size='small' label='Item 29' color='primary' variant='outlined' />
            <Typography variant='body2'>
              <strong>Knowable Community:</strong> Pseudonyms and handles are welcomed, anchored by peer vouchers or
              consensus fractals.
            </Typography>
          </Box>
          <Box sx={{ display: 'flex', gap: 1.5 }}>
            ...
            <Typography variant='body2'>
              <strong>Zero-Respect Access:</strong> New members immediately receive full read and comment capabilities
              across all community spaces.
            </Typography>
          </Box>
        </Stack>
      </Card>
